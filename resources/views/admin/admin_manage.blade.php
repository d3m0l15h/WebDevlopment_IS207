                    ...
                    <div class="col-lg-8  box-content">
                        <div class="box">
                            ...
                            <div class="view-content p-4">
                                <form class="input-group flex-nowrap mb-4 " action="{{ route('admin.user') }}"
                                    method="get">
                                            ...
                                            <div class="col a-box rounded-4 p-4 item-user w-50 position-relative"
                                                ...
                                                <div class="position-absolute end-0 mt-1 me-4">
                                                    <a class="btn btn-secondary bg-color"
                                                        href="{{route('admin.user_status', ['id' => $user->id])}}">
                                                        @if($user->status == '0')
                                                            Bật
                                                ...
                                                <div class="row">
                                                    <div class="col pt-2 ">
                                                        ...
                                                        <p class="pt-2  p-0 m-0">{{ $user->name }}</p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col pt-2 ">
                                                        <p class="row fw-bold p-0 m-0">Email</p>
                                                        <p class="pt-2 p-0 m-0">{{ $user->email }}</p>
                                                    </div>
                                                    <div class="col pt-2 ">
                                                        <p class="row fw-bold p-0 m-0">Username</p>
                                                        <p class="pt-2 p-0 m-0">{{ $user->accounts->first()->username }}</p>
                                                    </div>
                                                </div>
                                            </div>
